// Random note to self:
// It is absolutely important to call the selectOrDeselectAllOptionsForGeneralMultiselectDropdown
// function before the updateOptionsSelectedAndDropdownButtonTextForGeneralMultiselectDropdown
...
$(document).ready(function(){
  ...
  // update the text label accordingly,
  // and select or deselect all the options chosen based on the mode.
  $('.advanced-filter-dropdown .select-all').on('click', function(event) {
