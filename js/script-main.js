$(document).ready(function(){
  ...
  $("#storyModalButton000001").click(function() {
    ...
    // Center the images
    $("#story-modal-body").addClass('text-center');
  });
  ...
  $("#storyModalButton000002").click(function() {
    ...
    $("#story-modal-body").append('<audio controls><source src="../media/audio/skipping-stones.wav" type="audio/wav">Your browser does not support the audio element.</audio>');
  ...
  $("#storyModalButton000003").click(function() {
    ...
    // Left align the text
    $("#story-modal-body").removeClass('text-center');
  });
  ...
  $("#storyModalButton000007").click(function() {
    ...
    $("#story-modal-body").append('<audio controls><source src="../media/audio/cooking-wok.wav" type="audio/wav">Your browser does not support the audio element.</audio>');
    // Center the audio controls
    $("#story-modal-body").addClass('text-center');
  });
